...
<p>
    Tu fecha asignada es <b><?= htmlspecialchars($fecha ?? '') ?></b>.
</p>

<?php if (($_GET['msg'] ?? '') === 'esperar' || ($fecha && $fecha > date('Y-m-d'))): ?>

    <p class="aviso">
        Todavía no puedes avanzar. Vuelve cuando llegue tu fecha de inscripción.
    </p>
